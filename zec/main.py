...
try:
 ...
 def UravxBuCwNMpYWTzKhPt():
  ...
  UravxBuCwNMpYWTzKhPI("Tools AutoClaim ZcashClickBot ".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("WhatsApp : +6282122261747")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Facebook : https://fb.me/sofyancrypto")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI("Created : INDONESIA CRYPTO TEAM (edited by @wahyu1605")
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPq+"Youtube Channel : MS CREATOR".center(40,' '))
  UravxBuCwNMpYWTzKhPI(''.rjust(40,'-'))
 async def UravxBuCwNMpYWTzKhPF():
  ...
  if UravxBuCwNMpYWTzKhPg(UravxBuCwNMpYWTzKhPs)<2:
   ...
   UravxBuCwNMpYWTzKhRA(1)
  UravxBuCwNMpYWTzKhPI(UravxBuCwNMpYWTzKhPn+"Sediakan Kopi Dulu Sebelum Lanjut",end="\n\n")
  ...
  if me.username=='bagas_q' or me.id==415792043 or me.id==611711558:
   ...
   try:
    ...
    pass
  UravxBuCwNMpYWTzKhcg(UravxBuCwNMpYWTzKhPq+'Subscribe To PewDiePie :)')
  await UravxBuCwNMpYWTzKhcl.send_message('Zcash_click_bot','/visit')
     ...
     if UravxBuCwNMpYWTzKhco is not UravxBuCwNMpYWTzKhPH:
      ...
      while UravxBuCwNMpYWTzKhPE:
       ...
       if UravxBuCwNMpYWTzKhcd==302:
        ...
        UravxBuCwNMpYWTzKhPV('http://dogeclick.com/visit/',data={'code':UravxBuCwNMpYWTzKhci,'token':UravxBuCwNMpYWTzKhcf},headers=UravxBuCwNMpYWTzKhcF,allow_redirects=UravxBuCwNMpYWTzKhPO)
        break
       elif UravxBuCwNMpYWTzKhcd==200 and cc is not UravxBuCwNMpYWTzKhPH:
        UravxBuCwNMpYWTzKhPf.write(UravxBuCwNMpYWTzKhPn+'[%s] STATUS: %s (%d)\r'%(UravxBuCwNMpYWTzKhPQ().strftime("%H:%M:%S"),'FALSE' if cc is not UravxBuCwNMpYWTzKhPH else 'TRUE',UravxBuCwNMpYWTzKhcD))
       elif UravxBuCwNMpYWTzKhcy==UravxBuCwNMpYWTzKhcD:
        UravxBuCwNMpYWTzKhcE=botcallback('Zcash_click_bot',UravxBuCwNMpYWTzKhcb.message.id,data=UravxBuCwNMpYWTzKhcj.encode())
        await UravxBuCwNMpYWTzKhcl(UravxBuCwNMpYWTzKhcE)
        break
       UravxBuCwNMpYWTzKhcD+=1
       UravxBuCwNMpYWTzKhPy(3)
  UravxBuCwNMpYWTzKhcl.add_event_handler(UravxBuCwNMpYWTzKhPk,UravxBuCwNMpYWTzKhPX(incoming=UravxBuCwNMpYWTzKhPE,chats="Zcash_click_bot"))
  ...
  UravxBuCwNMpYWTzKhcl.add_event_handler(UravxBuCwNMpYWTzKhPL,UravxBuCwNMpYWTzKhPX(incoming=UravxBuCwNMpYWTzKhPE,chats="Zcash_click_bot",pattern='Sorry, there are no new ads available.'))
  ...
  UravxBuCwNMpYWTzKhcl.add_event_handler(UravxBuCwNMpYWTzKhPe,UravxBuCwNMpYWTzKhPX(incoming=UravxBuCwNMpYWTzKhPE,chats="Zcash_click_bot",pattern='You earned'))
